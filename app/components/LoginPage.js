...
const LoginPage = (props) => {
    const [email, setEmail] = useState('alandoe@test.com');
    ...
    const handleLogin = async () => {
        await signIn("credentials", {
            ...
            password: password,
            redirect: true,
            callbackUrl: "https://ecommerce-landing-page-pied.vercel.app/home"
        })
    }
                    ...
                    <div className="flex-1 mt-8">
                        <div className="flex flex-col items-center">
                            <button
                                ...
                                onClick={() => signIn('google', { callbackUrl: "https://ecommerce-landing-page-pied.vercel.app/home" })}
                            >
                        ...
                        <div className="mx-auto max-w-xs">
                            ...
                            />
                            {!!errorMessage && (<p className="text-red-500 text-xs font-['Lato']">Authentication failed</p>)}
                            <button
                            ...
                            <p className="mt-6 text-xs text-gray-600 text-center">
                                I agree to abide by techwama's{' '}
