        ...
        <footer>
                ...
                <div className="container">
                    ...
                    <ul className="footer-nav-list">
                        ...
                        <li className="footer-nav-item flex">
                            ...
                            <a href="tel:+607936-8058" className="footer-nav-link">(000) 000-0000</a>
                        </li>
            ...
            <div className="footer-bottom">
                ...
                <div className="container">
                    ...
                    <img src="https://res.cloudinary.com/dq0ns677p/image/upload/v1697803688/ecommerce/images/payment_tzstob.png" alt="payment method" className="payment-img" />

                    <p className="copyright">
                        Copyright &copy; <a href="#">CodeArt</a> all rights reserved.
                    </p>
